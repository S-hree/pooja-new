...
/* Enable ARM VFP state save/restore */
#define TX_ENABLE_FPU_SUPPORT

/* Enable reentrancy for Newlib functions */
#define TX_ENABLE_NEWLIB_SUPPORT

/* Enable stack overflow checking via MPU */
#define TX_ENABLE_MPU_STACK_CHECKING

/* Enable execution time profiling */
#define TX_ENABLE_EXECUTION_PROFILING

#ifdef TX_ENABLE_NEWLIB_SUPPORT
#define TX_THREAD_USER_EXTENSION  struct _reent tx_impure_data;
#endif

#ifdef TX_ENABLE_MPU_STACK_CHECKING
#define TX_MPU_STACK_CHECKING_REGION_NUMBER	    11
#define TX_MPU_STACK_CHECKING_REGION_SIZE_LOG2  6
#define TX_MPU_STACK_CHECKING_REGION_SIZE       (1 << TX_MPU_STACK_CHECKING_REGION_SIZE_LOG2)
#define TX_MPU_REGION_ENABLE                    1
#define TX_MPU_NO_ACCESS_NO_EXEC                0x1003
#endif
...
/* Define ThreadX system tick rate (in units of Hz).  */
...
#ifndef __ASSEMBLER__
/* Define execution time accumulator as 64-bit */
typedef unsigned long long              EXECUTION_TIME;
#endif

/* Enable hooks for ThreadX Execution Profile Kit */
#define TX_ENABLE_EXECUTION_CHANGE_NOTIFY

/* Enable PMU for execution time measurement */
#define TX_ENABLE_PMU

/* Define execution time source to be PMU cycle counter */
#define TX_EXECUTION_TIME_SOURCE        ((EXECUTION_TIME) ({ ULONG t; \
	__asm__ __volatile__ ("MRC p15, 0, %0, c9, c13, 0\n" : "=r"(t)); t; }))

/* Define maximum value of TX_EXECUTION_TIME_SOURCE for this port */
...
#ifdef TX_ENABLE_EXECUTION_PROFILING
/* Thread extension for ThreadX Execution Profile Kit */
...
CHAR                            _tx_version_id[] = 
                                    "Copyright (c) 1996-2012 Express Logic Inc. * ThreadX Cortex-R4/GNU Version G5.5.5.0 SN: 3696-111-0501 *";
#else
