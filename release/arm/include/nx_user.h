...
#define NX_IP_PERIODIC_RATE         TX_TICK_RATE
...
#define NX_TCP_KEEPALIVE_INITIAL    60
...
/* This define specifies how many seconds between retries of the keepalive timer assuming the other side
   ...
   retries.  */
#define NX_TCP_KEEPALIVE_RETRY      5
...
#define NX_PATH_MTU_INCREASE_WAIT_INTERVAL               (600 * TX_TICK_RATE)
#endif
